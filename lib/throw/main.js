...
const MAIN = {
  ...
  main : function() {
    ...
    // FUNCTIONS:
    /**
    *  Primary event handler using constants in Main::main namespace
    */
    function _init_line() {
    ...
    * @param string line_config_str - a six-character combination of 1 or 0
    * @return void
    */
    ...
    */
    ...
    if (window.location.search) {
      _init_hex_from_uri(_init_get(window.location.search))
    }
