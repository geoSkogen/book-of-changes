class Modal {
  ...
  */
  addShareableLink(hexagram_obj) {
    if (typeof Hexagram != 'function') {
      console.log('Modal::addShareableLink could not locate the Hexagram class definition.')
      return
    }
    ...
    if (hexagram_obj instanceof Hexagram) {
      ...
      this.#shareableLink.innerText = window.location.origin + window.location.pathname + query_string
    }
  }
