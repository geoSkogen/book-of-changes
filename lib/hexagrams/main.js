...
const MAIN = {
  ...
  main : function() {
    ...
    function _init_trigram_filter(trigram_arg,hex_half_arg) {
      ...
      if (typeof trigram_arg != 'number' && typeof trigram_arg != 'string') {
        console.log('MAIN::main _init_trigram_filter_render expects an integer or an ID string as argument 1.')
        return null
      }
      ...
      return BOOK.getHexagramsByTrigram(trigram_arg,hex_half_arg)
    }
