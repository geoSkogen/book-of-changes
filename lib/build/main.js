...
const MAIN = {
  ...
  main : function() {
    ...
    */
    ...
    //PROCEDURE:
    /**
    * Initial Test Pattern - pass the default line configuration set in the HTML document
    * TODO Wouldn't it be more static-HTML/data-agnostic to dynaimically render
    *  the line buttons' initial yin/yang values accoridng to the same arrays passed to this function?
    */
    _init_show_titles(
