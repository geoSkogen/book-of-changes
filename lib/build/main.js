...
const MAIN = {
  ...
  main : function() {
    ...
    * @return integer
    */
    function _init_get_hex_index_from_line_id(line_id) {
      ...
      if (line_id.split('-')[1] && Number(line_id.split('-')[1])) {
        ...
        console.log('updated hex index ' + hex_index.toString())
      } else {
    ...
    */
    function _init_show_titles(hexagrams,updated_line_id) {
      ...
      let updated_hex_index = updated_line_id ?
        _init_get_hex_index_from_line_id(updated_line_id) : null
